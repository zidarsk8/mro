...
simsignal_t MyServer::rcvdPkSignal = SIMSIGNAL_NULL;
simsignal_t MyServer::sentPkSignal = SIMSIGNAL_NULL;
...
void MyServer::sendOrSchedule(cMessage *msg, simtime_t delay)
{
    if (delay==0)
        sendBack(msg);
    else
...
void MyServer::sendBack(cMessage *msg)
{
