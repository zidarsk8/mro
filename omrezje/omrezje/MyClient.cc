...
void MyClient::handleTimer(cMessage *msg)
{
    switch (msg->getKind())
    {
...
void MyClient::socketEstablished(int connId, void *ptr)
{
...
void MyClient::socketDataArrived(int connId, void *ptr, cPacket *msg, bool urgent)
{
...
void MyClient::socketFailure(int connId, void *ptr, int code)
{
